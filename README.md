<picture>
  ...
  <source media="(min-width: 769px) and (prefers-color-scheme: light)" srcset="banners/banner-v2-light.svg">

  <source media="(max-width: 768px) and (prefers-color-scheme: dark)" srcset="banners/banner-v2-dark.svg">

  <img src="banners/banner-v2-dark.svg" alt="" width="100%" title="Sketchy banner using SVG's foreignObject">
</picture>
